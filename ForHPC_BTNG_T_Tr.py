...
def evaluate_l(X):
    ...
    if X==1:
        ...
        TIS= "CurrentTime==1.5 || CurrentTime==3 || CurrentTime==4.5 || CurrentTime==6 || CurrentTime==7.5 ||CurrentTime==9 || CurrentTime==10.5 || CurrentTime==12 || CurrentTime==13.5 || CurrentTime==15 || CurrentTime==16.5 || CurrentTime==18 || CurrentTime==19.5 || CurrentTime==21 || CurrentTime==22.5"
    elif X==6:
        TIS= "Hour==0 || Hour==2 || Hour==4 || Hour==6 || Hour==8 || Hour==10 || Hour==12 || Hour==14 || Hour==18 || Hour==20 || Hour==22"
    elif X==7:
        TIS= "CurrentTime==2.5 || CurrentTime==5 || CurrentTime==7.5 || CurrentTime==10 || CurrentTime==12.5 ||CurrentTime==15 || CurrentTime==17.5 || CurrentTime==20 || CurrentTime==22.5"
    elif X==8:
        TIS= "Hour==0 || Hour==3 || Hour==6 || Hour==9 || Hour==12 || Hour==15 || Hour==18 || Hour==21"
    elif X==9:
        TIS= "CurrentTime==3.5 || CurrentTime==7 || CurrentTime==10.5 || CurrentTime==16 || CurrentTime==19.5 ||CurrentTime==23.5"
    else:
